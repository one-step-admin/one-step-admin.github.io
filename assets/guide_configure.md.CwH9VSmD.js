import{_ as a,c as i,a4 as n,o as l}from"./chunks/framework.DqIFRz44.js";const e="/settings.png",o=JSON.parse('{"title":"配置","description":"","frontmatter":{},"headers":[],"relativePath":"guide/configure.md","filePath":"guide/configure.md"}'),p={name:"guide/configure.md"};function t(h,s,k,d,c,r){return l(),i("div",null,s[0]||(s[0]=[n(`<h1 id="配置" tabindex="-1">配置 <a class="header-anchor" href="#配置" aria-label="Permalink to &quot;配置&quot;">​</a></h1><h2 id="环境配置" tabindex="-1">环境配置 <a class="header-anchor" href="#环境配置" aria-label="Permalink to &quot;环境配置&quot;">​</a></h2><p>默认提供三套环境配置，分别为：</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-hyqwP" id="tab-dWngDdq" checked><label data-title=".env.development 开发环境" for="tab-dWngDdq">.env.development 开发环境</label><input type="radio" name="group-hyqwP" id="tab-5OZ9cwm"><label data-title=".env.test 测试环境" for="tab-5OZ9cwm">.env.test 测试环境</label><input type="radio" name="group-hyqwP" id="tab-kSkuIse"><label data-title=".env.production 生产环境" for="tab-kSkuIse">.env.production 生产环境</label></div><div class="blocks"><div class="language-yaml vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 应用配置面板</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  },</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><div class="warning custom-block"><p class="custom-block-title">注意</p><p>如果文档中提供的配置介绍，在你本地的开发环境中报错或者无法生效，说明你使用的版本不支持或者配置参数有变动，你可以打开 <code>/src/settings.default.ts</code> 查看当前版本的完整配置作为参考。并且如果你使用的是 Visual Studio Code ，鼠标悬浮到属性上时，会有属性的介绍：</p><p><img src="`+e+'" alt="" data-zoomable=""></p></div>',12)]))}const g=a(p,[["render",t]]);export{o as __pageData,g as default};
